...
testSuite({
    ...
    afterRun: function(output) {
        ...
        safeCheckConsoleIndexValueEquals(0, 'Friday is a school day');
        safeCheckConsoleIndexValueEquals(1, 'Saturday is NOT a school day');
        safeCheckConsoleIndexValueEquals(2, 'Sunday is NOT a school day');
